...
sc = SparkContext("local", "Run 1 SVM narrow Data95-08 Single Node")
data_file = sc.textFile("95-08.csv")
...
# Save and load model
model.save(sc, "SVMnarrow9508")
sameModel = SVMModel.load(sc, "SVMnarrow9508")
