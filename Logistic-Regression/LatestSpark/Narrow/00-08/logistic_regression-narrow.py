...
sc = SparkContext ("local", "Run 1 - Logistic Regression Narrow - Data00-08 - Single Node")
...
#save and load model
model.save (sc, "LRN-00-08")
sameModel = LogisticRegressionModel.load (sc, "LRN-00-08")
sc.stop ()
