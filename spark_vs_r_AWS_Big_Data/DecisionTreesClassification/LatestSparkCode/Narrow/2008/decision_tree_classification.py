...
sc = SparkContext (appName= "Run 1 - Decision Tree Classification Narrow - Data2008 - AWS- 80G")
...
#save and load model
model.save(sc, "DT-Class-N-2008")
sameModel = DecisionTreeModel.load(sc, "DT-Class-N-2008")
sc.stop ()
