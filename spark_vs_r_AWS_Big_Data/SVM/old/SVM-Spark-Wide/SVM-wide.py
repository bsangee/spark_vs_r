...
def parsePoint(line):
	...
	symbolic_indexes = [1, 2, 3, 5, 7, 8, 12, 18, 21]
	...
	return LabeledPoint(values[8], values[0:7]) #dep_delay, cancelled, diverted, carrierdelay, weather delay, NASdelay, Security delay, LateAircraftdelay
