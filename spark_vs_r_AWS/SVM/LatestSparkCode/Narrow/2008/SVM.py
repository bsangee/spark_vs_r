...
sc = SparkContext(appName= "Run 1 SVM narrow Data2008 training AWS")
data_file = sc.textFile(""s3://aws-logs-012060642840-us-west-2/elasticmapreduce/cloud_proj/2008.csv")
