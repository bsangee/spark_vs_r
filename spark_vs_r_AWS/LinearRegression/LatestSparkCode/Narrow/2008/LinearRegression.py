...
sc = SparkContext(appName= "Run1 Linear Regression Data2008 AWS")
def parsePoint(line):
...
data_file = sc.textFile("s3://aws-logs-012060642840-us-west-2/elasticmapreduce/cloud_proj/2008.csv").cache ()
