...
for(i in dataFiles){
  ...
  try({
    ...
    write.csv(summary(wide_model)$cptable,paste0("DecisionTree/",strsplit(i,"\\.")[[1]][1]," wide decision tree R.txt"))
  ...
  try({
    ...
    write.csv(summary(narrow_model)$cptable,paste0("DecisionTree/",strsplit(i,"\\.")[[1]][1]," narrow decision tree R.txt"))
