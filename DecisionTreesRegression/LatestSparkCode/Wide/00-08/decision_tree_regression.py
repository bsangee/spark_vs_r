...
sc = SparkContext ("local[*]", "Run 1 - Decision Tree Regression Wide - Data00-08 - Single Node")
...
#save and load model
model.save (sc, "DTR-Wide-00-08")
sameModel = DecisionTreeModel.load (sc, "DTR-Wide-00-08")
sc.stop ()
