...
sc = SparkContext ("local[*]", "Run 1 - Decision Tree Regression Narrow - Data95-08 - Single Node")
...
#save and load model
model.save (sc, "DTR-Narrow-95-08")
sameModel = DecisionTreeModel.load (sc, "DTR-Narrow-95-08")
sc.stop ()
