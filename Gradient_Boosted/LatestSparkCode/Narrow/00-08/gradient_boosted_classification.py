...
sc = SparkContext ("local[*]", "Run 1 - Gradient Boosted Classification Narrow - Data00-08 - Single Node")
...
#save and load model
model.save(sc, "GB-Class-N-00-08")
sameModel = DecisionTreeModel.load(sc, "GB-Class-N-00-08")
sc.stop ()
